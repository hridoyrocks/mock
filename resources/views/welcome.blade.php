<x-guest-layout>
    <x-slot name="title">Your Path to IELTS Success</x-slot>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight">
                            We Take Your IELTS Score
                            <span class="relative inline-block">
                                <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600">Higher</span>
                        ...
                        <p class="text-lg md:text-xl text-gray-700 mb-4 font-medium">
                            Get ready for your 2025 IELTS exam by practicing our <span class="font-bold text-gray-900">100+ IELTS mock tests</span> 
                            <span class="inline-flex items-center bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-bold ml-1">FOR FREE</span>
                        </p>
                        
                        <!-- Student Avatars -->
                        <div class="flex items-center justify-center lg:justify-start mb-8">
                            <div class="flex -space-x-3">
                                <img src="https://i.pravatar.cc/150?img=1" alt="Student 1" class="w-12 h-12 rounded-full border-3 border-white shadow-md">
                                <img src="https://i.pravatar.cc/150?img=2" alt="Student 2" class="w-12 h-12 rounded-full border-3 border-white shadow-md">
                                <img src="https://i.pravatar.cc/150?img=3" alt="Student 3" class="w-12 h-12 rounded-full border-3 border-white shadow-md">
                                <img src="https://i.pravatar.cc/150?img=4" alt="Student 4" class="w-12 h-12 rounded-full border-3 border-white shadow-md">
                                <div class="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-full border-3 border-white flex items-center justify-center text-white font-semibold text-sm shadow-md">+10K</div>
                            </div>
                            <p class="ml-4 text-gray-600 font-medium">
                                <span class="font-bold text-gray-900">10,000+ students</span> are using our free services
                            </p>
                        </div>
                        
                        <!-- CTA Button -->
                        <div class="mb-10">
                            <a href="{{ route('register') }}" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-500 to-red-600 text-white font-bold text-lg rounded-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-200 group">
                                START NOW
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="font-bold text-gray-900">Instant AI Evaluation</h3>
                                    <p class="text-sm text-gray-600 font-normal">Get detailed feedback in seconds</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 font-normal">Expert teachers review your work</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="font-bold text-gray-900">Real Exam Format</h3>
                                    <p class="text-sm text-gray-600 font-normal">Practice with authentic materials</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="font-bold text-gray-900">Progress Tracking</h3>
                                    <p class="text-sm text-gray-600 font-normal">Monitor improvement daily</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-20 bg-gradient-to-b from-white to-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Why use IELTS Online Tests?</h2>
                <p class="text-lg text-gray-600 font-medium max-w-2xl mx-auto">Everything you need to succeed in your IELTS journey</p>
            </div>
