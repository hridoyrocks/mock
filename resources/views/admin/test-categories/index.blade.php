        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold">Test Categories</h2>
                    ...
                    <table class="min-w-full table-auto">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700" id="sortable-categories">
                            @foreach($categories as $category)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700" data-id="{{ $category->id }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center justify-center w-10 h-10 rounded-lg" style="background-color: {{ $category->color }}20;">
                                            ...
                                            @elseif($category->icon == 'clipboard-list')
                                                <svg class="w-6 h-6" style="color: {{ $category->color }};" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            @elseif($category->icon == 'light-bulb')
                                                <svg class="w-6 h-6" style="color: {{ $category->color }};" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm">
                                            <span class="font-medium text-gray-900 dark:text-white">{{ $category->active_test_sets_count }}</span>
                                            <span class="text-gray-500 dark:text-gray-400">/ {{ $category->test_sets_count }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <form action="{{ route('admin.test-categories.toggle-status', $category) }}" 
                                                  method="POST" 
                                                  class="inline">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" 
                                                        class="{{ $category->is_active ? 'text-yellow-600 hover:text-yellow-900 dark:text-yellow-400' : 'text-green-600 hover:text-green-900 dark:text-green-400' }}"
