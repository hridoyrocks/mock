                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" rows="4" required
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('content') border-red-300 @enderror">{{ old('content', $announcement->content) }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-4 border-t pt-4">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="action_button_text" id="action_button_text" 
                                           value="{{ old('action_button_text', $announcement->action_button_text) }}"
                                ...
                                <div>
                                    ...
                                    <input type="url" name="action_button_url" id="action_button_url" 
                                           value="{{ old('action_button_url', $announcement->action_button_url) }}"
