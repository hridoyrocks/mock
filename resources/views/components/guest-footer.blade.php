        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-gray-800 font-semibold text-lg">IELTS Mock Platform</span>
                </div>
                ...
                <div class="flex space-x-4">
                    <!-- Social Icons -->
                    <a href="#" class="w-10 h-10 bg-white/50 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-white/70 transition-all group">
        ...
        <div class="pt-8 border-t border-gray-200">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="text-center md:text-left">
                    <p class="text-gray-600">© 2024 IELTS Mock Platform. All rights reserved.</p>
                    <p class="text-gray-500 text-sm mt-1">Made with ❤️ for IELTS aspirants</p>
                </div>
